...
1. Read references/run-contract.md, references/baseline-and-synthesis.md, and references/roles-and-rubrics.md.
...
6. After any rewrite, rerun evidence review on the exact artifacts.
